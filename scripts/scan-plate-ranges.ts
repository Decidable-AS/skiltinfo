/**
 * Scan the Vegvesen API to find active plate ranges and cache them in
 * src/data/plate-ranges.json.
 *
...
async function main() {
  ...
  console.log(`Done: ${Object.keys(ranges).length} active prefixes, ${requestCount} API calls`);
}
